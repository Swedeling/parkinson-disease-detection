...
Dostępne są również zaawansowane techniki obrazowania, takie jak PET (pozytonowa emisyjna tomografia) oraz SPECT (tomografia emisyjna pojedynczego fotonu), które pozwalają na obserwację metabolizmu w układzie pozapiramidowym.
Skan DAT (skan transportera dopaminy) jest przykładem SPECT i może być sugerowany przez specjalistę.
Mimo to ostateczna diagnoza opiera się na objawach oraz wynikach badania neurologicznego, a DAT nie jest wymagany.
...
Tematem przewodnim tej pracy magisterskiej jest rola głosu w kontekście choroby Parkinsona.
